	...
	<div class="ld-subpage-content">
		<div class="checkout-content">
			<section class="checkout">
                ...
                </span> <a class="accordion-btn open" data-toggle="collapse" href="#collapse-three"></a></h2>

									<div class="accordion-body collapse in" id="collapse-three">
                ...
                </span> <a class="accordion-btn open" data-toggle="collapse" href="#collapse-four"></a></h2>

									<div class="accordion-body collapse in" id="collapse-four">
												...
												<table class="table checkout-table">
													...
													<tr>
														<td class="product-name-col">
															<figure>
																<a href="#"><img src="{{ asset('ecommerce/img/product/special-item-1.jpg') }}" alt="White linen sheer dress"></a>
															</figure>
													...
													<tr>
														<td class="product-name-col">
															<figure>
																<a href="#"><img src="{{ asset('ecommerce/img/product/special-item-2.jpg') }}" alt="Black lace open back dress"></a>
															</figure>
