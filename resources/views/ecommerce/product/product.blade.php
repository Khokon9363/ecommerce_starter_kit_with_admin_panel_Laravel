...
@section('custom_css')
   <link rel="stylesheet" href="{{ asset('ecommerce/css/flexslider.css') }}">
   <link rel="stylesheet" href="{{ asset('ecommerce/css/image-light-box.css') }}">
   <link rel="stylesheet" href="{{ asset('ecommerce/css/setting.css') }}">
@endsection
					...
					<div class="row">
						<div class="col-md-5 col-sm-6 summary-before ">
							<div class="product-slider product-shop">
								...
								<ul class="slides">
									<li data-thumb="{{ asset('ecommerce/img/temp-images/hoodie_7_front-140x140.jpg') }}">
										<a href="{{ asset('ecommerce/img/temp-images/hoodie_7_front.jpg') }}" data-imagelightbox="gallery" class="hoodie_7_front">
											<img src="{{ asset('ecommerce/img/temp-images/hoodie_7_front-470x470.jpg') }}" class="attachment-shop_single" alt="image">
										</a>
									</li>
									<li data-thumb="{{ asset('ecommerce/img/temp-images/hoodie_7_back-140x140.jpg') }}">
										<a href="{{ asset('ecommerce/img/temp-images/hoodie_7_back.jpg') }}" data-imagelightbox="gallery" class="hoodie_7_back">
											<img src="{{ asset('ecommerce/img/temp-images/hoodie_7_back-470x470.jpg') }}" class="attachment-shop_single" alt="image">
										</a>
									</li>
								</ul>
							</div>
												...
												<div id="product-carousel" class="product-listing">
													...
													<div class="product  item first ">
														<article>
															<figure>
																<a href="#">
																	<img src="{{ asset('ecommerce/img/temp-images/T_5_front-300x300.jpg') }}" class="img-responsive " alt="T_5_front">
																</a>
																<figcaption><span class="amount">$20.00</span></figcaption>
															</figure>
													...
													<div class="product  item first ">
														<article>
															<figure>
																<a href="#">
																	<img src="{{ asset('ecommerce/img/temp-images/hoodie_2_front-300x300.jpg') }}" class="img-responsive" alt="hoodie_2_front">
																</a>
													...
													<div class="product  item first ">
														<article>
															<figure>
																<a href="#">
																	<img src="{{ asset('ecommerce/img/temp-images/T_4_front-300x300.jpg') }}" class="img-responsive" alt="T_4_front">
																</a>
																<figcaption>
													...
													<div class="product  item first ">
														<article>
															<figure>
																<a href="#">
																	<img src="{{ asset('ecommerce/img/temp-images/T_7_front-300x300.jpg') }}" class="img-responsive" alt="T_7_front">
																</a>
													...
													<div class="product  item first ">
														<article>
															<figure>
																<a href="#">
																	<img src="{{ asset('ecommerce/img/temp-images/T_6_front-300x300.jpg') }}" class="img-responsive" alt="T_6_front">
																</a>
																<figcaption><span class="amount">$20.00</span></figcaption>
															</figure>
															<h4 class="title"><a href="#">Woo Ninja</a></h4>
													...
													<div class="product  item first ">
														<article>
															<figure>
																<a href="#">
																	<img src="{{ asset('ecommerce/img/temp-images/hoodie_4_front-300x300.jpg') }}" class="img-responsive" alt="hoodie_4_front">
																</a>
																<figcaption><span class="amount">$35.00</span></figcaption>
															</figure>
															<h4 class="title"><a href="#">Happy Ninja</a></h4>
													...
													<div class="product  item first ">
														<article>
															<figure>
																<a href="#">
																	<img src="{{ asset('ecommerce/img/temp-images/hoodie_3_front-300x300.jpg') }}" class="img-responsive" alt="hoodie_3_front">
																</a>
																<figcaption><span class="amount">$35.00</span></figcaption>
															</figure>
									...
									<div id="reviews">
										<div class="row">
													...
													<ol class="commentlist">
														<li class="comment depth-1">
															<div class="comment_container">
																<img alt="gravatar" src="{{ asset('ecommerce/img/temp-images/com-grav1.jpg') }}" class="avatar photo">
                                            ...
                                            <i class="fa fa-star-o"></i>
														...
														<li class="comment  depth-1">
															<div class="comment_container">
																<img src="{{ asset('ecommerce/img/temp-images/com-grav2.jpg') }}" alt="image" class="avatar photo">
																<div class="comment-text">
																	<p class="meta">
                                                                            <span class="star-rating" title="Rated 4.00 out of 5">
                                            <i class="fa fa-star"></i>
                                            ...
                                            <i class="fa fa-star-o"></i>
														...
														<li class="comment depth-1">
															...
															<div class="comment_container">
																...
																<img src="{{ asset('ecommerce/img/temp-images/com-grav3.jpg') }}" alt="image" class="avatar photo">
																<div class="comment-text">
...
@push('custom_js')
   <script src="{{ asset('ecommerce/js/flexslider/jquery.flexslider-min.js') }}"></script>
   <script src="{{ asset('ecommerce/js/image-lightbox/imagelightbox.js') }}"></script>
   <script>
       /*-----------------------------------------------------------------------------------*/
        /* Flex Slider
        /*-----------------------------------------------------------------------------------*/
